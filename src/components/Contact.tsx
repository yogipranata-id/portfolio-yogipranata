      ...
      >
        ...
        <div className="relative overflow-hidden rounded-3xl p-[1px]">
          ...
          <div
            ...
            style={{
              background: "conic-gradient(from 0deg, rgba(34,211,238,0.3), rgba(168,85,247,0.3), rgba(34,211,238,0.1), rgba(168,85,247,0.3), rgba(34,211,238,0.3))",
              animation: "spin 8s linear infinite",
            }}
          />

          {/* Inner card */}
          <div className="relative rounded-3xl bg-[#050816] p-8 text-center sm:p-16">
            {/* Floating icon */}
            <motion.div
              className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl border border-cyan-400/20 bg-cyan-400/10 text-cyan-400"
              animate={{ y: [0, -6, 0] }}
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <a
                ...
                className="group inline-flex items-center gap-2 rounded-full bg-cyan-400 px-8 py-4 font-bold text-slate-950 transition-all duration-300 hover:scale-105 hover:bg-cyan-300 hover:shadow-[0_0_30px_rgba(34,211,238,0.35)]"
              >
                <Mail size={20} />
                {t("sendEmail")}
              </a>
